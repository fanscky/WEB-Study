...
####1.7.2. PHP赋值运算符
  ...
  下例展示了使用不同赋值运算符的不同结果：  
  ┖[demo_php_operator_assignment.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_operator_assignment.php)
...
####1.7.3. PHP字符串运算符
  ...
  下例展示了使用字符串运算符的结果：  
  ┖[demo_php_operator_string.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_operator_string.php)
...
####1.7.4. PHP递增/递减运算符
  ...
  ┖[demo_php_operator_increment.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_operator_increment.php)
...
####1.7.5. PHP比较运算符
  ...
  下例展示了使用某些比较运算符的不同结果：  
  ┖[demo_php_operator_comparison.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_operator_comparison.php)
...
####1.7.7. PHP数组运算符
  ...
  下例展示了使用不同数组运算符的不同结果：  
  ┖[demo_php_operator_array.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_operator_array.php)  
...
┖[demo_php_if.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_if.php)  
...
┖[demo_php_if_else.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_if_else.php)  
...
┖[demo_php_if_elseif.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_if_elseif.php)
...
**实例**  
┖[demo_php_switch.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_switch.php)
...
┖[demo_php_loop_while.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_loop_while.php)
...
下面的例子首先把变量 $x 设置为 1（$x=1）。然后，do while 循环输出一段字符串，然后对变量 $x 递增 1。随后对条件进行检查（$x 是否小于或等于 5）。只要 $x 小于或等于 5，循环将会继续运行：  ┖[demo_php_loop_do_while.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_loop_do_while.php)
...
┖[demo_php_loop_do_while2.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_loop_do_while2.php)
...
**实例：**  
┖[demo_php_loop_for.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_loop_for.php)
...
**实例：**  
┖[demo_php_loop_foreach.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_loop_foreach.php)
...
┖[demo_php_function1.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_function1.php)
...
┖[demo_php_function2.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_function2.php)

**实例2：**

下面的例子中的函数有两个参数（$fname 和 $year）：  
┖[demo_php_function3.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_function3.php)
...
┖[demo_php_function4.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_function4.php)
...
**实例：**  
┖[demo_php_function5.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_function5.php)
...
数组在单个变量中存储多个值：  
┖[demo_php_array_num.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_array_num.php)
...
**实例：**  
┖[demo_php_array_length.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_array_length.php)

####1.13.5. 遍历索引数组

如需遍历并输出索引数组的所有制，您可以使用 for 循环，就像这样：
┖[demo_php_array_num_loop.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_array_num_loop.php)
...
**实例：**  
┖[demo_php_array_assoc.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_array_assoc.php)
...
**实例：**  
┖[demo_php_array_assoc_loop.php](http://192.168.215.116/w3c_php_test/PHP/Base/demo_php_array_assoc_loop.php)
